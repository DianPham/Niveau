...
// * AdminLTE/plugins: An object mapping plugin names to configuration
//   options.
...
//   to the Acorn and Tern libraries and any Tern AdminLTE/plugins you want to
...
(function(mod) {
  ...
  CodeMirror.TernServer = function(options) {
    ...
    var AdminLTE/plugins = this.options.AdminLTE/plugins || (this.options.AdminLTE/plugins = {});
    if (!AdminLTE/plugins.doc_comment) AdminLTE/plugins.doc_comment = true;
  ...
  function WorkerServer(ts) {
    ...
    worker.postMessage({type: "init",
                        ...
                        AdminLTE/plugins: ts.options.AdminLTE/plugins,
