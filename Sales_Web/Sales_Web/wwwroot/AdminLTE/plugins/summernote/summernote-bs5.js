...
var Context = /*#__PURE__*/function () {
  ...
  _createClass(Context, [{
    ...
    value: function _initialize() {
      ...
      var modules = external_jQuery_default().extend({}, this.options.modules, (external_jQuery_default()).summernote.AdminLTE/plugins || {}); // add and initialize modules
  ...
  VideoDialog_createClass(VideoDialog, [{
    ...
    value: function createVideoNode(url) {
      ...
      if (ytMatch && ytMatch[1].length === 11) {
        ...
        $video = external_jQuery_default()('<iframe>').attr('frameborder', 0).attr('src', 'https://www.facebook.com/AdminLTE/plugins/video.php?href=' + encodeURIComponent(fbMatch[0]) + '&show_text=0&width=560').attr('width', '560').attr('height', '301').attr('scrolling', 'no').attr('allowtransparency', 'true');
      } else {
