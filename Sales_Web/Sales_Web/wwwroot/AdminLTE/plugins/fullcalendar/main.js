...
var FullCalendar = (function (exports) {
    ...
    */
    function expandRecurringRanges(eventDef, duration, framingRange, dateEnv, recurringTypes) {
        ...
        // the recurrence AdminLTE/plugins don't guarantee that all-day events are start-of-day, so we have to
        if (eventDef.allDay) {
    ...
    */
    ...
    function buildEventSourceMeta(raw, context) {
        ...
        for (var i = defs.length - 1; i >= 0; i -= 1) { // later-added AdminLTE/plugins take precedence
            var def = defs[i];
    ...
    */
    ...
    /*
    this array is exposed on the root namespace so that UMD AdminLTE/plugins can add to it.
    see the rollup-bundles script.
    */
    var globalAdminLTE/plugins = [
    ...
    var CalendarDataManager = /** @class */ (function () {
        ...
        CalendarDataManager.prototype.processRawCalendarOptions = function (optionOverrides, dynamicOptionOverrides) {
            ...
            var pluginHooks = this.buildPluginHooks(optionOverrides.AdminLTE/plugins || [], globalAdminLTE/plugins);
            ...
            for (var optionName in raw) {
                if (optionName !== 'AdminLTE/plugins') { // because AdminLTE/plugins is special-cased
        ...
        CalendarDataManager.prototype._computeCurrentViewData = function (viewType, optionsData, optionOverrides, dynamicOptionOverrides) {
            ...
            if (!viewSpec) {
                throw new Error("viewType \"" + viewType + "\" is not available. Please make sure you've loaded all neccessary AdminLTE/plugins");
            }
    ...
    */
    ...
    globalAdminLTE/plugins.push(interactionPlugin, dayGridPlugin, timeGridPlugin, listPlugin, plugin, googleCalendarPlugin);
    ...
    exports.globalAdminLTE/plugins = globalAdminLTE/plugins;
