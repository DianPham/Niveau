...
_**Important Note**: You needed to add separately cdn links for AdminLTE/plugins in your project._
```html
...
#### Via Composer
```bash
composer require "almasaeed2010/adminlte=Sales_Web/wwwroot/3.2"
```
#### Via Git
```bash
